...
const landingPages = {
  ...
  "/business/smartstore-margin": {
    name: "스마트스토어 마진 계산",
    title: "스마트스토어 마진 계산 - 원가·수수료·광고비 순이익 | 하루툴",
    description: "스마트스토어 판매가에서 상품 원가, 네이버페이 수수료, 배송·포장비, 광고비를 빼고 순이익·마진율·손익분기 판매가를 확인하는 계산 가이드입니다.",
  ...
  "/business/coupang-margin": {
    name: "쿠팡 판매가 마진 계산",
    title: "쿠팡 판매가 마진 계산 - 수수료·배송비 손익분기 | 하루툴",
    description: "쿠팡 판매가에서 상품 원가, 카테고리 수수료, 배송비, 포장비, 광고비를 반영해 순이익·마진율·손익분기 판매가를 비교하는 계산 가이드입니다.",
  ...
  "/business/vat-price": {
    name: "부가세 포함 가격 계산",
    title: "부가세 포함 가격 계산 - 공급가액·VAT 역산 | 하루툴",
    description: "부가세 포함 합계금액에서 공급가액과 VAT를 역산하거나 공급가액에 부가세를 더해 견적·세금계산서 금액을 확인하는 사업자용 계산 가이드입니다.",
